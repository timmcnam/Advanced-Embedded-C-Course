...
#define LCD_DDR_BIT7_INPUT (DDRK &= ~BIT_7)
#define LCD_DDR_BIT7_OUTPUT (DDRK |= BIT_7)
#define LCD_BIT7_READ (PORTK & BIT_7)
...
#define LCD_COLOR_DDRX (DDRE = 0x0C) 

// These macros change our display depending on certain conditions
#define CLEAR_DISPLAY 0x01
#define HOME_DISPLAY 0x02
#define SECOND_LINE 0xc0
 
// BackLight Macros
#define DISPLAY_OFF (PORTE &= ~(BIT_3 | BIT_2))
#define DISPLAY_RED (PORTE &= ~BIT_3) & (PORTE |= BIT_2) 
#define DISPLAY_GREEN (PORTE |= BIT_3) & (PORTE &= ~BIT_2)
#define DISPLAY_BLUE (PORTE |= (BIT_3 | BIT_2))
